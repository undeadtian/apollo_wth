...
bool FusionComponent::Init() {
  ...
  // 配置文件在modules/perception/production/conf/perception/fusion/fusion_component_conf.pb.txt
  ...
  writer_ = node_->CreateWriter<PerceptionObstacles>(
      comp_config.output_obstacles_channel_name()); // "/perception/vehicle/obstacles"
